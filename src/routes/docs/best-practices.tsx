...
export const Route = createFileRoute("/docs/best-practices")({
  head: () => ({
    meta: pageMeta(
      ...
      "Tips for getting the most out of Labonair and mobile-first agent workflows.",
    ),
  }),
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-white/60 leading-relaxed">
          What I've learned from using Labonair daily. Not rules, just patterns that have worked for
          me.
        </p>
      </div>
      ...
      <section className="space-y-4">
        ...
        <p className="text-white/60 leading-relaxed">
          Don't be shy about running multiple agents. Labonair lets you launch agents in isolated
