...
export function downloadUrls(version: string) {
  ...
  return {
    macAppleSilicon: `${base}/Labonair-${version}-arm64.dmg`,
    macIntel: `${base}/Labonair-${version}-x64.dmg`,
    linuxAppImage: `${base}/Labonair-${version}-x86_64.AppImage`,
    linuxDeb: `${base}/Labonair-${version}-amd64.deb`,
    linuxRpm: `${base}/Labonair-${version}-x86_64.rpm`,
    windowsExe: `${base}/Labonair-Setup-${version}.exe`,
    androidApk: `${base}/labonair-v${version}-android.apk`,
  };
}

export const appStoreUrl = "https://apps.apple.com/app/labonair-pocket-engineer/id6758887924";
export const playStoreUrl = "https://play.google.com/store/apps/details?id=sh.labonair";
export const webAppUrl = "https://app.labonair.sh";
